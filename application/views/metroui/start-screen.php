                ...
                navigator.geolocation.getCurrentPosition(function(position){
                    ...
                    $.ajax({
                        ...
                        geocoder.geocode({latLng: latlng}, function(result, status){
                            ...
                            $("#weather_bg").css({
                                'background-image': 'url(http://metroui.org.ua/images/'+current.icon+'.jpg'+')'
                            });
                        }
                    });
                });
...
<body style="overflow-y: hidden;">
    ...
    <div class="tile-area tile-area-scheme-dark fg-white" style="height: 100%; max-height: 100% !important;">
        <h1 class="tile-area-title">开发中...</h1>
        <div class="tile-area-controls">
            ...
            <a href="http://metroui.org.ua/tiles.html" class="square-button bg-transparent fg-white bg-hover-dark no-border"><span class="mif-switch"></span></a>
        </div>
            ...
            <div class="tile-container">
                <div class="tile-wide" data-role="tile" data-effect="slideLeft">
                    <div class="tile-content">
                        <a href="http://google.com/search?q=bear" class="live-slide"><img src="http://metroui.org.ua/images/1.jpg" data-role="fitImage" data-format="fill"></a>
                        <a href="http://google.com/search?q=cat" class="live-slide"><img src="http://metroui.org.ua/images/2.jpg" data-role="fitImage" data-format="fill"></a>
                        <a href="http://google.com/search?q=dog" class="live-slide"><img src="http://metroui.org.ua/images/3.jpg" data-role="fitImage" data-format="fill"></a>
                        <a href="http://google.com/search?q=eagle" class="live-slide"><img src="http://metroui.org.ua/images/4.jpg" data-role="fitImage" data-format="fill"></a>
                        <a href="http://google.com/search?q=fox" class="live-slide"><img src="http://metroui.org.ua/images/5.jpg" data-role="fitImage" data-format="fill"></a>
                    </div>
                    <div class="tile-label">Gallery</div>
                </div>
                <div class="tile" data-role="tile" data-role="tile" data-effect="slideUpDown">
                    <div class="tile-content">
                        <div class="live-slide"><img src="http://metroui.org.ua/images/me.jpg" data-role="fitImage" data-format="fill"></div>
                        <div class="live-slide"><img src="http://metroui.org.ua/images/spface.jpg" data-role="fitImage" data-format="fill"></div>
                    </div>
                ...
                <div class="tile-wide bg-orange fg-white" data-role="tile">
                    <div class="tile-content image-set">
                        <img src="http://metroui.org.ua/images/jeki_chan.jpg">
                        <img src="http://metroui.org.ua/images/shvarcenegger.jpg">
                        <img src="http://metroui.org.ua/images/vin_d.jpg">
                        <img src="http://metroui.org.ua/images/jolie.jpg">
                        <img src="http://metroui.org.ua/images/jek_vorobey.jpg">
                    </div>
                </div>
        ...
        <div class="tile-group double">
            ...
            <div class="tile-container">
                <div class="tile" data-role="tile">
                    <div class="tile-content">
                        <img src="http://metroui.org.ua/images/grid2.jpg" data-role="fitImage" data-format="square">
                    </div>
                </div>
                <div class="tile-small" data-role="tile">
                    <div class="tile-content">
                        <img src="http://metroui.org.ua/images/Battlefield_4_Icon.png" data-role="fitImage" data-format="square">
                    </div>
                </div>
                <div class="tile-small" data-role="tile">
                    <div class="tile-content">
                        <img src="http://metroui.org.ua/images/Crysis-2-icon.png" data-role="fitImage" data-format="square" data-frame-color="bg-steel">
                    </div>
                </div>
                <div class="tile-small" data-role="tile">
                    <div class="tile-content">
                        <img src="http://metroui.org.ua/images/WorldofTanks.png" data-role="fitImage" data-format="square" data-frame-color="bg-dark">
                    </div>
                </div>
                <div class="tile-small" data-role="tile">
                    <div class="tile-content">
                        <img src="http://metroui.org.ua/images/halo.jpg" data-role="fitImage" data-format="square">
                    </div>
                </div>
                <div class="tile-wide bg-green fg-white" data-role="tile">
                    <div class="tile-content iconic">
                        <img src="http://metroui.org.ua/images/x-box.png" class="icon">
                    </div>
