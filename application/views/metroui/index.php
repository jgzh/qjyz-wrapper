                    ...
                    <div class="cell">
                        <div class="carousel square-bullets" data-height="360" data-role="carousel" data-direction="left">
                            ...
                            for ($i = 0; $i < (count($imgs[1]) > 8 ? 8 : count($imgs[1])); $i++) {
                                echo "<div class=\"slide\"><a href=\"./image/{$imgs[1][$i]}\"><img src=\"{$imgs[2][$i]}\" data-role=\"fitImage\" data-format=\"fill\"></a></div>\n";
                            }
                            ?>
                        </div>
                            ...
                            <div class="content">
                                ...
                                <ul class="simple-list green-bullet underline">
                                    ...
                                    for ($i = 0; $i < (count($publicity[1]) > 8 ? 8 : count($publicity[1])); $i++) {
                                        echo "<li><a href='./publicity/{$publicity[1][$i]}'><div><span>{$publicity[2][$i]}</span><span class='place-right'>{$publicity[3][$i]}</span></div></a></li>\n";
                                    }
                                    ?>
                                </ul>
                            </div>
                            ...
                            <div class="content">
                                ...
                                <ul class="simple-list blue-bullet underline">
                                    ...
                                    for ($i = 0; $i < (count($news[1]) > 20 ? 20 : count($news[1])); $i++) {
                                        echo "<li><a href='./news/{$news[1][$i]}'><div><span>{$news[2][$i]}</span><span class='place-right'>{$news[3][$i]}</span></div></a></li>\n";
                                    }
                                    ?>
                                </ul>
                            </div>
                            ...
                            <div class="cell">
                                <ul class="simple-list large-bullet red-bullet underline">
                                    ...
                                    for ($i = 0; $i < (count($nemt[1]) > 8 ? 8 : count($nemt[1])); $i++) {
                                        echo "<li><a href='./nemt/{$nemt[1][$i]}'><div><span>{$nemt[2][$i]}</span><span class='place-right'>{$nemt[3][$i]}</span></div></a></li>\n";
                                    }
                                    ?>
                                </ul>
                            </div>
                            <div class="cell">
                                <ul class="simple-list large-bullet red-bullet underline">
                                    ...
                                    for ($i = 0; $i < (count($award[1]) > 8 ? 8 : count($award[1])); $i++) {
                                        echo "<li><a href='./award/{$award[1][$i]}'><div><span>{$award[2][$i]}</span><span class='place-right'>{$award[3][$i]}</span></div></a></li>\n";
                                    }
                                    ?>
                                </ul>
                            </div>
